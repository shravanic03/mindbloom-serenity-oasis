    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow pt-20">
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8">
            <h1 className="text-3xl font-bold mb-2">Welcome to PMHS</h1>
            <p className="text-gray-600">
              Your personal space for mental wellbeing.
            </p>
          </div>
              ...
              {quickActions.map((action, index) => (
                ...
                >
                  <div className="flex items-start space-x-4">
                    <div className="bg-PMHS-purple/10 p-3 rounded-full">
                      <action.icon className="h-6 w-6 text-PMHS-purple" />
                    </div>
                    <div>
          ...
          <section className="mb-12">
            ...
            <div className="bg-PMHS-pink-light/30 p-6 rounded-xl border border-PMHS-pink/10">
              <h3 className="text-lg font-medium mb-2">Mindful Moment</h3>
              <p className="text-gray-700 mb-4">
                Take a 5-minute break today to simply sit and observe your
                breath. Notice the sensations of breathing without trying to
                change anything. This small practice can help center your mind
                and reduce stress.
              </p>
              <div className="text-sm text-PMHS-pink">
                <span className="font-medium">Remember:</span> Small acts of
                self-care add up to significant wellbeing over time.
              </div>
            </div>
          </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {moodTips.map((item, index) => (
                <div key={index} className="bg-white p-5 rounded-xl shadow-sm">
                  <h3 className="font-medium text-PMHS-purple mb-2">
                    {item.mood}
                  </h3>
          ...
          <section>
            <div className="flex justify-between items-center mb-4">
              ...
              <Button variant="link" to="/books">
                View All
              </Button>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="bg-PMHS-purple/5 p-4 rounded-lg">
                  <span className="text-sm font-medium text-PMHS-purple block mb-2">
                    Book
                  </span>
                ...
                <div className="bg-PMHS-pink/5 p-4 rounded-lg">
                  <span className="text-sm font-medium text-PMHS-pink block mb-2">
                    Movie
                  </span>
