  ...
  const handleRescheduleAppointment = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error
          ? err.message
          : "Error rescheduling appointment. Please try again later."
      );
      console.error(err);
    } finally {
      setLoading(false);
            ...
            <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-8">
              ...
              {loading && (
                <div className="flex justify-center items-center py-8">
                  <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-PMHS-purple"></div>
                </div>
              )}
                ...
                <div className="space-y-6">
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-green-800">
                    ...
                    <p>
                      ...
                      {currentAppointment?.date} at {selectedTime}.
                    </p>
                  ...
                  <div className="bg-PMHS-purple/5 rounded-lg p-4">
                    <h3 className="text-lg font-medium mb-2">What to Expect</h3>
                    <p className="text-gray-700 mb-4">
                      You'll receive a confirmation email with details about
                      your appointment and how to prepare. Your therapist will
                      meet you via video call at the scheduled time.
                    </p>
                    <p className="text-gray-700">
                      If you need to reschedule or cancel, please do so at least
                      24 hours in advance.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full p-3 pl-10 border border-gray-300 rounded-md focus:ring-PMHS-purple focus:border-PMHS-purple"
                        disabled={loading}
                      >
