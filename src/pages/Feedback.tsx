          ...
          <div className="container mx-auto px-4 py-16">
            <div className="max-w-lg mx-auto bg-white rounded-xl shadow-md p-8 text-center">
              ...
              <p className="text-gray-600 mb-8">
                ...
                us. Your feedback helps us improve our services and better
            ...
            <div className="max-w-3xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-1">
                  <div className="bg-PMHS-purple/10 p-6 rounded-xl">
                    <MessageSquare className="h-10 w-10 text-PMHS-purple mb-4" />
                    <h2 className="text-xl font-semibold mb-3">
                      Why Your Feedback Matters
                    </h2>
                    <p className="text-gray-600 mb-6">
                      Your insights help us create a better experience for
                      everyone in our community. We use your feedback to improve
                      our resources, services, and overall approach.
                    </p>
                    <div className="border-t border-PMHS-purple/20 pt-4">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full p-3 border border-gray-300 rounded-md focus:ring-PMHS-purple focus:border-PMHS-purple resize-none"
                      ...
                      <div className="flex items-start">
                        ...
                        >
                          I consent to having my feedback reviewed by the PMHS
                          team. They may contact me for follow-up if needed.
                        </label>
                      </div>
